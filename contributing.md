...
Adobe 설명서에 대한 [기여자 안내서](https://experienceleague.adobe.com/en/docs/contributor/contributor-guide/introduction)를 참조하세요.
...
기여도를 재배포할 수 있는 권한을 Adobe에 부여하는 CLA(라이선스 계약)
