...
1. _[!DNL Content]_갤러리의 검색 및 필터 도구를 사용하여 활성화할 환경을 식별한 다음&#x200B;**[!UICONTROL 활성화]**를 클릭합니다.
...
_[!DNL Content]_에서 승인된 경험을 직접 활성화하지 않도록 선택하는 경우 에셋을 선택하고, 종횡비 및 초안 텍스트 요소를 할당할 수 있습니다.

**활성화를 위한 환경을 준비하려면**:

1. _[!DNL Activate]_에서 선택한 유료 채널을 나타내는 아이콘의&#x200B;**[!UICONTROL 새로 만들기]**를 클릭합니다._&#x200B;경험 설정&#x200B;_보기가 열립니다.
...
1. 미디어 자산을 선택합니다. _[!DNL Content]_의 자산을 사용하거나 외부 자산(예: OneDrive 또는 Dropbox)을 업로드할 수 있습니다.
...
1. _[!DNL Activate]_에서 채널 카드의&#x200B;**[!UICONTROL 새로 만들기]**를 클릭합니다._&#x200B;경험 설정&#x200B;_보기가 열립니다.
...
1. _[!DNL Activate]_에서 메타 타일에서&#x200B;**[!UICONTROL 새로 만들기]**를 클릭합니다._&#x200B;경험 설정&#x200B;_창이 열립니다.
