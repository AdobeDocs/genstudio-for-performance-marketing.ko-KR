...
1. _[!DNL Content]_갤러리의 검색 및 필터 도구를 사용하여 활성화할 환경을 식별한 다음&#x200B;**[!UICONTROL 사용]**을 클릭하세요. (또는 Google Campaign Manager 360 제품 카드에서&#x200B;**[!UICONTROL 새로 만들기]**를 클릭하여_[!DNL Activate]_&#x200B;에서 환경을 선택할 수 있습니다.)
