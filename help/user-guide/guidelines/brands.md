...
다음 표는 브랜드 음성 지침과 지침 예제의 각 카테고리를 보여줍니다.
...
다음 표는 이미지 지침과 관련 값의 각 카테고리를 보여 줍니다. 이미지 지침을 적용하려면 [일반 미술 지침이나 제품 사진 촬영 등의 범주를 설정](add-guidelines.md#add-brands)해야 합니다.

| 지침 범주 | 설명 | 값 |
| ------------------| :---------- | :---------- |
| [!UICONTROL 설명] | &quot;제품 사진&quot; 또는 &quot;일반 아트 가이드라인&quot;과 같이 추가된 특정 이미지 가이드라인 범주에 대한 일반 정보 | 지침 문서에서 추출하고 수동으로 구성할 수 있는 <br><br>_일반 아트 지침의 예_: &quot;일러스트레이션 및 3D 렌더링과 같이 사진이 아닌 이미지에 적용되는 지침&quot; |
| [!UICONTROL 콘텐츠 형식] | 이미지에 사용 가능한 콘텐츠 유형 | _아트_ 또는 _사진_ |
| 컴포지션 | 개체, 카메라 및 사진 기법 배치에 대한 세부 정보 | 지침 문서에서 추출되고 수동으로 구성 가능 |
| [!UICONTROL 환경] | 이미지의 배경 요소 등 환경 관련 세부 정보 | _예_: &quot;햇볕이 잘 드는 환경을 사용하십시오.&quot; |
| [!UICONTROL 색상] | 색상 계열, 색상 온도, 기본/2차/3차 색상, 색조, 채도, 대비 관련 세부 정보 | 지침 문서에서 추출하고 수동으로 구성할 수 있습니다&#x200B;<br><br>_예_: &quot;산만함을 최소화하면서 제품이 주요 초점이 되는지 확인&quot;, &quot;선명한 색상&quot; |
| [!UICONTROL 조명] | 조명과 관련된 일반 또는 특정 세부 정보 | 지침 문서에서 추출하고 수동으로 구성할 수 있습니다&#x200B;<br><br>_예_: &quot;사용자 앞에 링 라이트를 놓으십시오&quot; |
| [!UICONTROL 기분] | 이미지의 느낌을 설명합니다. | 지침 문서에서 추출하고 수동으로 구성할 수 있습니다&#x200B;<br><br>_예_: &quot;이미지는 항상 긍정적이고 즐거운 테마를 표시해야 합니다.&quot; |
| [!UICONTROL 제한] | 다른 지침에 관계없이 피해야 할 사항 | 지침 문서에서 추출하고 수동으로 구성할 수 있습니다&#x200B;<br><br>_예_: &quot;흐린 환경에서 사진을 촬영하지 마십시오&quot;, &quot;부정적인 테마를 사용하지 마십시오&quot;, &quot;색상을 씻을 수 없습니다&quot; |
...
| 섹션 | 채널 | 설명 | 모범 사례 |
| ------------------| --------- | --------- | -------- |
| 일반 | 이메일, Meta, 배너 및 디스플레이 광고 | 두 번째 제목란 또는 이메일 미리 보기 텍스트 | 이메일(2~5개 지침) 전체에서 일관되도록 전체 톤/감정을 정의합니다.<br>_예_: &quot;친숙하고 접근 가능한 톤 유지&quot;, &quot;지나치게 형식적인 언어 사용 금지&quot;<br><br> |
| 제목 | 이메일 | 이메일 콘텐츠를 요약하는 매력적이고 흥미로운 제목 | 톤, 길이 등에 대한 구체적인 지침(2~5개 지침)을 제공합니다. 더 나은 품질의 출력을 위해 _예제_ 섹션에 이전에 성공한 제목을 추가하십시오.<br>_예제_: &quot;제목을 이메일 본문에 맞춤&quot; |
| 사전 머리글 | 이메일 | 두 번째 제목란 또는 이메일 미리 보기 텍스트 | 톤, 이상적인 길이 등에 대한 특정 지침(2~5개 지침)을 제공합니다. _예_ 섹션에서 이전에 성공한 사전 헤더를 추가하여 출력 품질을 개선하십시오.<br>_예_: &quot;60~80자로 제한&quot; |
| 제목 | 이메일, Meta, 배너 및 디스플레이 광고, LinkedIn | 독자의 관심을 끌기 위한 제목이나 구문입니다. | 톤, 이상적인 길이 등에 대한 특정 지침(2~5개 지침)을 제공합니다. _예_ 섹션에서 이전에 성공한 헤드라인을 추가하여 품질을 개선하십시오.<br>_예_: &quot;주의를 집중하려면 점성 있는 구문을 사용하십시오.&quot; |
| 하위 헤드라인 | 이메일, 배너 및 디스플레이 광고 | 독자의 관심을 끌기 위한 두 번째 또는 세 번째 제목 또는 구문 | 톤, 이상적인 길이 등을 정의하는 특정 지침(2~5개 지침)을 제공합니다. _예_ 섹션에서 이전에 성공한 하위 헤드라인을 추가하여 품질을 개선하십시오.<br>_예_: &quot;주의를 집중하려면 점성 있는 구문을 사용하십시오.&quot; |
...
| 본문 | 이메일, Meta, 배너 및 디스플레이 광고, LinkedIn | 메시지, 링크 및 이미지가 포함된 마케팅 콘텐츠 | 톤, 이상적인 길이 등에 대한 특정 지침(2~5개 지침)을 제공합니다. 더 나은 품질의 출력을 위해 이전에 성공한 복사본을 _예_ 섹션에 추가하십시오.<br>_예_: &quot;80~100자로 제한&quot;, &quot;과도한 두문자어 사용 안 함&quot; |
| 이미지 내 텍스트 | Meta, LinkedIn | 이미지 위에 표시되는 텍스트의 톤, 이상적인 길이 등에 대한 특정 지침 | 음색, 이상적인 길이 등에 대한 구체적인 지침(1-2문장)을 제공하라. 더 나은 품질의 출력을 위해 이전에 성공한 텍스트를 _예제_ 섹션에 추가하십시오.<br>_예제_: &quot;순간에 포커스&quot; |
| Call-to-action(CTA) | 이메일, Meta, 배너 및 디스플레이 광고 | (Call to action) 응답을 유도하는 판독기에 제공된 지침입니다. 일반적으로 하나 또는 두 단어(예: `Get started`) | 톤, 이상적인 길이 등에 대한 특정 지침(2~5개 지침)을 제공합니다. _예_ 섹션에 이전에 성공한 CTA를 추가하여 출력 품질을 개선하십시오.<br>_예_: &quot;끝 구두점을 사용하지 마십시오.&quot; |
...
일관되고 액세스 가능한 텍스트 스타일을 위해 개별 [!DNL Brands] 내의 색을 관리합니다. 16진수 코드 또는 RGB 코드로 색상을 선택하거나 정의하며, 단색만 지원됩니다(불투명도는 지원되지 않음). 색상을 무제한으로 추가하고, 갤러리 형식으로 보고, 16진수 또는 RGB 코드에서 사람이 읽을 수 있는 이름으로 이름을 바꿀 수 있습니다.
