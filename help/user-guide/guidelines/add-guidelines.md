...
>[!TIP]
>
만든 브랜드만 보려면 [!DNL Brands] 필터(funnel 아이콘)에서 **[!UICONTROL 사용자가 만든]**&#x200B;을(를) 선택하십시오.
...
[!DNL brand]에는 녹색 점과 이름 옆에 &quot;게시됨&quot;이 표시되며 **[!UICONTROL 게시]** 단추 대신 **[!UICONTROL [!DNL brand]]** 편집 단추가 나타납니다.
...
1. _설명_ 섹션에 [!DNL product]에 대한 정보를 추가하십시오.
...
[!DNL Audiences]이(가) [_[!DNL Create]_워크플로](../create/overview.md#templates)의 매개 변수 창에 드롭다운으로 나타납니다._[!DNL Audiences]_ 두 지침을 모두 사용하는 경우 _[!DNL Personas]_에 특이성을 추가할 수 있지만 독립적으로 효과적으로 사용할 수도 있습니다.
