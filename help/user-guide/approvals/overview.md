...
콘텐츠 편집자 및 승인자는 Slack에서 이러한 알림을 수신하기 위해 등록할 수 있습니다. [CX Enterprise에서 서비스 가입](https://experienceleague.adobe.com/ko/docs/core-services/interface/services/customer-attributes/subscription)을 참조하십시오.
