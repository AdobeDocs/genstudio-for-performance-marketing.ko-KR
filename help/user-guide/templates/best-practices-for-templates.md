...
자리 표시자 텍스트는 나중에 사용자가 템플릿에서 채울 콘텐츠의 구문 또는 구조를 정의하는 데 도움이 될 수 있습니다. 예: {first_name}{last_name}@email 등 이메일 주소를 정의합니다. 그러나 일부 일반적인 구분 기호는 GenStudio for Performance Marketing에서 다른 의미로 이미 예약되어 있습니다.
