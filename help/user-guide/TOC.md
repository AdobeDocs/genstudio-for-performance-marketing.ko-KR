...
+ AI 도우미 {#ai-assistants}
  ...
  + [AI 지원 도구 참조](ai-assistants/tools-reference.md)
+ 설정 {#settings}
...
+ 만들기 {#create}
  ...
  + [연결된 TV 광고](create/create-ctv.md)
  + [광고 경험 표시](create/display-ad-experiences.md)
  + [배너 경험](create/banner-experiences.md)
  + [변형 관리](create/manage-variants.md)
  + [상태 저장 생성으로 콘텐츠 생성 및 세분화](create/stateful-generation.md)
  + [경험 번역 및 현지화](create/translate-experiences.md)
  + [공동 편집](create/collaborative-editing.md)
  + [로고 교체 사용](create/logo-swap.md)
...
+ 템플릿 {#templates}
  ...
  + [빠른 템플릿 사용](/help/user-guide/templates/express-templates.md)
...
+ 활성화 {#activation}
  ...
  + 유료 미디어 광고 {#paid-media-ads}
    ...
    + [무역 담당](activation/activate-trade-desk-ad.md)
+ Insights {#insights}
  + [인사이트 개요](insights/overview.md)
  + [인사이트 필터](insights/filter-views.md)
  + [캠페인](insights/campaigns.md)
  + [게시된 경험 세부 정보](insights/published-experiences.md)
  + [미디어](insights/media.md)
  + [광고 태그](insights/ad-tags.md)
  + 속성 {#attributes}
    + [특성 정보](insights/attributes.md)
...
+ 통합 {#integrations}
  ...
  + [GenStudio Photoshop 플러그인](integrations/photoshop-plugin.md)
