...
_[!DNL Generative Actions]_&#x200B;Adobe GenStudio for Performance Marketing 제품 설명[에 정의된 ](https://helpx.adobe.com/legal/product-descriptions/adobe-genstudio-for-performance-marketing---product-description.html)은(는) GenStudio for Performance Marketing에서 생성 AI 기능의 사용을 정량화하는 단위입니다.
