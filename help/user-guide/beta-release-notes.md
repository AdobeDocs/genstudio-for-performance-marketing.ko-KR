...
* Adobe Express을 사용하여 이미지 에셋(JPG 또는 PNG)을 직접 편집할 수 있습니다. 콘텐츠 편집자는 _[!UICONTROL Adobe Express 제공]_ 캔버스를 사용하여 GenStudio for Performance Marketing에서 나가지 않고 배경을 제거하고, 생성 채우기를 적용하고, 효과를 조정하고, 이미지를 자를 수 있습니다. <!-- GS-4615 -->
...
* 이제 Meta 광고 내보내기 중에 올바른 글꼴이 적용됩니다. <!-- GS-5875 -->

* 업로드에 성공했지만 제품 인터페이스에서 가시성 부족 문제가 해결되었습니다. <!-- GS-4815 5650-->

* 이제 사용자는 크기를 조정한 후 Meta 광고를 수동으로 자를 수 있습니다. <!-- GS-5871 -->

* 사용자가 Facebook에 로그인할 때 채널 Meta 광고 계정에 더 이상 두 번 로그인할 필요가 없습니다. <!-- GS-3009 -->
...
* **[!UICONTROL PNG로 내보내기]**&#x200B;를 선택하면 이제 디스플레이 광고를 PNG 파일로 내보냅니다. 이전에는 PNG 형식을 선택하면 디스플레이 광고를 JPEG으로 내보냈습니다. <!-- GS-5545 -->
...
* 사용자가 생성된 이메일, Meta 광고 또는 디스플레이 광고를 편집한 후에는 브랜드 유효성 검사 점수가 더 이상 무효화되지 않습니다. 이전에는 이 점수가 숨겨졌습니다. <!-- GS-5379 -->
...
* [!DNL Create] 전자 메일 또는 Meta 광고 캔버스에서 문자열 사이에 누락된 공백이 추가되었습니다. <!-- GS-5019 -->
