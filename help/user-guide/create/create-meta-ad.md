...
이 튜토리얼에서는 GenStudio for Performance Marketing [[!DNL Create]](/help/user-guide/create/overview.md)(왼쪽 탐색 영역에 있는 페인트 브러쉬 아이콘)을 사용하여 브랜드 [Meta 광고 경험](/help/user-guide/create/meta-experiences.md)을 생성하는 방법을 보여 줍니다.

단일 이미지 또는 비디오 광고 대신 다중 카드 캐러셀 광고를 만들려면 [Meta 캐러셀 광고 경험 만들기](/help/user-guide/create/create-meta-carousel-ad.md)를 참조하십시오.
...
미리 정의된 지침([!DNL Brands], [!DNL Personas] 또는 [!DNL Products] 등)이 있는 템플릿을 사용하는 경우 이러한 지침은 변형에 적용됩니다. 원하는 경우 변경할 수 있습니다.
