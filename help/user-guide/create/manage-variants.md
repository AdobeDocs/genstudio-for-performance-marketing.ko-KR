...
1. 단면의 텍스트를 다시 생성하는 동안 재생성 아이콘을 클릭하여 추가 텍스트 옵션을 확인합니다.
...
변형 세트를 생성한 후 클릭 유도 문안(CTA) 텍스트 및 링크를 수정할 수 있습니다.

**변형에서 CTA을 개정하려면**:

1. 변형 세트를 생성한 후 CTA 텍스트를 표시하는 버튼을 클릭합니다.
1. CTA 단추 텍스트를 변경하려면 _콜 투 액션_ 목록에서 사용 가능한 옵션 중에서 선택하십시오.
1. CTA에서 링크를 변경하려면 **[!UICONTROL 링크]**&#x200B;를 클릭하세요.
   1. _링크 편집_ 섹션에서 새 링크를 입력하거나 붙여 넣거나 기존 링크를 수정하고 **[!UICONTROL 적용]**&#x200B;을 클릭합니다. 새 링크를 입력하기 전에 **[!UICONTROL 링크 제거]**&#x200B;를 클릭하여 기존 링크를 제거할 수 있습니다.
