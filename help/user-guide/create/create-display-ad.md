...
기본적으로 프롬프트, 지침 및 추가한 컨텐츠를 기반으로 한 변형이 생성되고 캔버스에 표시됩니다.
...
생성된 광고를 최적화하고 브랜드 정체성을 엄격히 준수하려면 포괄적인 브랜드 유효성 검사 세부 정보를 표시하고 개선 영역을 표시하는 [_브랜드 유효성 검사 패널_](/help/user-guide/guidelines/brand-validation.md#brand-validation-panel)&#x200B;의 기능을 활용하십시오.

**브랜드 정렬을 확인하려면**:

1. 상단 메뉴 모음의 브랜드 유효성 검사 아이콘을 클릭하여 [_브랜드 유효성 검사 패널_](/help/user-guide/guidelines/brand-validation.md#brand-validation-panel)&#x200B;을 엽니다. 개선이 필요한 조각 및 지침에 대한 세부 사항을 볼 수 있습니다.

1. 각 광고를 전환하여 생성된 콘텐츠를 브랜드 맞춤형으로 개선하는 방법을 확인합니다.
1. [수동으로 광고를 수정](#revise-generated-display-ads)하여 이메일이 브랜드와 밀접하게 연계되도록 합니다.
